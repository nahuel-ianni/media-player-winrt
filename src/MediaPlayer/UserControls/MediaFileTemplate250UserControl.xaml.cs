...
{
    public sealed partial class MediaFileTemplate250UserControl : UserControl
    {
        public MediaFileTemplate250UserControl()
        {
        ...
        {
            Image thumbnailImage = ((((Windows.UI.Xaml.Controls.Panel)(sender)).Children).ToArray()[1]) as Image;
